...
### Preprints
- **Under Review** — **Choi, K**., Shin, Y., Kim, Y., Osman, K., & Kim, H. (2026). "MANTA: Multivariate Attention Network for Short-Term Water-Level Forecasting", *SSRN*. [[SSRN]](https://ssrn.com/abstract=6479487){:target="_blank"} · [[Live System]](https://sil.manta-pado.store/){:target="_blank"}
